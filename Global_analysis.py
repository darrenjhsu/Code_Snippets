...
def SVDplot(data,x,t,n_cmp=None):
...
data += np.random.normal(size=data.shape) * 0.01
...
def SVD_GlobalAnalysis(x, t, data, xminmax, tminmax, i_cmp, funVec, initialGuess, fitFlag=True, plot_flag=False):
